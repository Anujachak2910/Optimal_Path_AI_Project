...
[![Hugging Face Space](https://img.shields.io/badge/Hugging%20Face-Space-blue)](https://anuc2910-smartroute-maps.hf.space/)
...
- **AI and Graph Processing**: OSMnx, NetworkX, Pytz (Timezone Analysis)
- **Geocoding and API**: Geopy, OpenStreetMap, OSRM Public API
